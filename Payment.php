    ...
    <body onload="loadPaymentInformation(), oneWay(<?php echo $_SESSION["num"]; ?>)">
        ...
        <div class="content">
            ...
            <div class="info-container""> 
                <div class="leftDescription">
                    ...
                    <p id="displayFinalTotalAmount" style="display: inline-table;"><b>0.00</b></p>
                </div>
                <div class="panelHeader">
                    ...
                    <div class="payment--options">
                        ...
                        <div class="placeorder content-wrapper">
                            ...
                            <script src="https://www.paypal.com/sdk/js?client-id=AY73ky6y89NgWv1dA6mwZxCeou8UTRMiTlkfvJo3slDqeHsMpqin8Zi69pFvaGI_d7VRD5e7PDHIMwsc"></script>
            ...
            onApprove: function (data, actions) {
                return actions.order.capture().then(function (details) {
                    ...
                    window.location.replace("http://localhost/flight_ticketing_system/receipt.php");
                });
            },
            onCancel: function (data) {
                document.getElementById("paymentStatus").innerHTML = "Payment Cancelled. No Transaction was made.";
            }
        ...
        <script>
            ...
            function loadPaymentInformation() {
                ...
                document.getElementById("totalArrivalTicketPrice").innerHTML = 'MYR ' + localStorage.getItem("totalArrivalTicketPrice");
                document.getElementById("totalArrivalPassenger").innerHTML = 'Passenger x ' + localStorage.getItem("totalArrivalPassenger");
